  ...
  return (
    ...
    <div className="bg-black">
        ...
        <div className="mb-4">
            ...
            <div className="relative ">
                ...
                <div className="flex justify-center mt-4">
                    ...
                    <div>
                        <button className="flex bg-red-600 border-[1px] border-red-600 px-8 py-[10px] rounded-[3px] hover:text-gray-100  hover:bg-red-800 text-white font-semibold">Vamos lá</button>
        ...
        <div className="justify-center col-1 pb-96 mt-96">
            ...
            <div className=" flex justify-center items-center px-72 text-white group "> 
                <img className=" w-32"src={pipoca} alt="pipoca" />
                <div className="bg-gradient-to-r from-purple-950 via-indigo-950 to-indigo-950 px-10 py-4 flex rounded-[20px] hover:px-20 hover:py-5 hover:bg-gradient-to-r hover:from-purple-900 hover:via-indigo-900 hover:to-indigo-950  hover:rounded[24px] hover:ease-in duration-300">
                    <div className="group">
                        <h3 className="text-[28px] font-semibold">A Netflix que você adora por apenas R$ 20,90.</h3>
                        <p className="text-[24px] ">Aproveite nossa opção mais acessível, o plano com anúncios.</p>
                    </div>
                    
                    <div>
                        <button className="text-[24px] bg-neutral-700 px-10 mx-6 py-2 mt-2 ml-48 rounded-[10px] hover:bg-neutral-800">Saiba mais</button>
                    </div>
                </div>
            ...
            <div className="bg-neutral-600 mb-4 hover:bg-neutral-500">
